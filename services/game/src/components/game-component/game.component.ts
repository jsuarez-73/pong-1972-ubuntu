...
export class Game {
	...
	protected	msg_request: Subject<MessageGame> = new Subject<MessageGame>();
	protected	msg_response: Subject<MessageGame> = new Subject<MessageGame>();
	protected	disposal_game_service: (() => void) = () => {};
	...
	* with the Auth Service. (Maybe)*/
	...
	public	ft_incommingSocket (socket: WebSocket, _req: SocketRequest) {
	...
	protected	ft_setPlayer (socket: WebSocket, tag: e_TAG_PLAYER) {
