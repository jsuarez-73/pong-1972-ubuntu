...
cum_avg_counter = df_subset["cumulativeRewardAverage"] 
avg_cum = []
avg_cum_cum = 0
cum_counter = 0
...
plt.plot(df_subset["episodes"], df_subset["cumulativeRewardAverage"] * 10)
plt.plot(df_subset["episodes"], avg_cum)
plt.plot(df_subset["episodes"], df_subset["epsilon"] * 50)
